...
sf_meet <- toString(
  paste0(
    round(bg[bg$Subpopulation == 'SampleFrame', 'LCB80Pct.P'], 1), '% (LCL ',
    round(bg[bg$Subpopulation == 'SampleFrame', 'Estimate.P'], 1), ', UCL ',  
    round(bg[bg$Subpopulation == 'SampleFrame', 'UCB80Pct.P'], 1), ')' ) )

de_meet <- toString(
  paste0(
    round(bg[bg$Subpopulation == 'DE-NCA', 'LCB80Pct.P'], 1), '% (LCL ',
    round(bg[bg$Subpopulation == 'DE-NCA', 'Estimate.P'], 1), ', UCL ',  
    round(bg[bg$Subpopulation == 'DE-NCA', 'UCB80Pct.P'], 1), ')' ) )

acec_meet <- toString(
  paste0(
    round(bg[bg$Subpopulation == 'ACEC-WSA', 'LCB80Pct.P'], 1), '% (LCL ',
    round(bg[bg$Subpopulation == 'ACEC-WSA', 'Estimate.P'], 1), ', UCL ', 
